...
## GetAdvertisementsByCollection(self, collection\_id) ##
...
## GetHostByHostname(self, hostname, with\_apps=False, with\_usage=False) ##
...
## GetSubCollections(self, collection\_id) ##
